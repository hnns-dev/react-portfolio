  ...
  return (
    <div className="card bg-stone-400 bg-opacity-20 backdrop-blur-lg rounded-xl overflow-hidden shadow-lg h-full flex flex-col">
      ...
      <div className="p-6 flex flex-col flex-grow">
        <p className="font-titillium text-xl font-bold text-amber-600 mb-2">
          {title}
        </p>
        <p className="text-amber-50 mb-4 flex-grow">{description}</p>
        <div className="flex justify-between mt-auto gap-24 md:gap-2">
